...
arianagrande <- read_csv(file.path("canciones/ArianaGrande.csv"))
beyonce <- read_csv(file.path("canciones/Beyonce.csv"))
billieeilish <- read_csv(file.path("canciones/BillieEilish.csv"))
bts <- read_csv(file.path("canciones/BTS.csv"))
drake <- read_csv(file.path("canciones/Drake.csv"))
edsheeran <- read_csv(file.path("canciones/EdSheeran.csv"))
eminem <- read_csv(file.path("canciones/Eminem.csv"))
justinbieber <- read_csv(file.path("canciones/JustinBieber.csv"))
ladygaga <- read_csv(file.path("canciones/LadyGaga.csv"))
postmalone <- read_csv(file.path("canciones/PostMalone.csv"))
rihanna <- read_csv(file.path("canciones/Rihanna.csv"))
```
